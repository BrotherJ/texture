...
<script type="text/javascript">
	...
	function goPage(pageNum){
		...
		window.location.href="<%=basePath %>/textureReportSearch/getBackList/?page="+pageNum+"&texture="+texture+"&furnace_No="+furnace_No+"&createUser="+createUser+"&beginDate="+beginDate+"&endDate="+endDate;
	}
	...
	function search(){
		...
		var beginDate =$('#beginDate').datebox('getValue'); 
		var endDate =$('#endDate').datebox('getValue'); 
		window.location.href="<%=basePath %>/textureReportSearch/getBackList/?page=1&texture="+texture+"&furnace_No="+furnace_No+"&createUser="+createUser+"&beginDate="+beginDate+"&endDate="+endDate;
	}
	...
	function exportExcel(){
		...
		var beginDate =$('#beginDate').datebox('getValue'); 
		var endDate =$('#endDate').datebox('getValue'); 
		window.location.href="<%=basePath %>/textureReportSearch/exportBackList?texture="+texture+"&furnace_No="+furnace_No+"&createUser="+createUser+"&beginDate="+beginDate+"&endDate="+endDate;
	}
...
<body>
	<h3 style="margin-bottom: 0px;margin-top: 0px">零件材质报告退回清单 </h3>
