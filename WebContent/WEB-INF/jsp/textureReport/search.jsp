...
<script type="text/javascript">
	...
	function goPage(pageNum){
		...
		window.location.href="<%=basePath %>/textureReportSearch/initSearch?page="+pageNum+"&texture="+texture+"&furnace_No="+furnace_No+"&createUser="+createUser+"&status="+status+"&beginDate="+beginDate+"&endDate="+endDate;
	}
	...
	function search(){
		...
		var beginDate =$('#beginDate').datebox('getValue'); 
		var endDate =$('#endDate').datebox('getValue'); 
		window.location.href="<%=basePath %>/textureReportSearch/initSearch/?page=1&texture="+texture+"&furnace_No="+furnace_No+"&createUser="+createUser+"&status="+status+"&beginDate="+beginDate+"&endDate="+endDate;
	}
	...
	function showAddInfo(texture,furnace_No){
		$.ajax({ 
            cache: true, 
            type: "POST", 
            url:"<%=basePath %>/textureReportSearch/getAddInfoByTextureAndFurnaceNo?texture="+texture+"&furnace_No="+furnace_No, 
            dataType:"json",
            async: false, 
	...
	<div id="textureInfo">
		<table id='table1'  class="list">
			<tr>
				...
				<th scope="col" style="width: 65px;">修改人</th>
				<th scope="col" style="width: 50px;">修改日期</th>
