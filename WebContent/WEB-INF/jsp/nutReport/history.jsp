...
<script type="text/javascript">
	...
	function goPage(pageNum){
		...
		window.location.href="<%=basePath %>/nutReportSearch/getHistoryList/?page="+pageNum+"&texture="+texture+"&furnace_No="+furnace_No+"&createUser="+createUser+"&beginDate="+beginDate+"&endDate="+endDate;
	}
	...
	function search(){
		...
		var beginDate =$('#beginDate').datebox('getValue'); 
		var endDate =$('#endDate').datebox('getValue'); 
		window.location.href="<%=basePath %>/nutReportSearch/getHistoryList/?page=1&texture="+texture+"&furnace_No="+furnace_No+"&createUser="+createUser+"&beginDate="+beginDate+"&endDate="+endDate;
	}
	...
	function exportExcel(){
		...
		var beginDate =$('#beginDate').datebox('getValue'); 
		var endDate =$('#endDate').datebox('getValue'); 
		window.location.href="<%=basePath %>/nutReportSearch/exportHistoryList?texture="+texture+"&furnace_No="+furnace_No+"&createUser="+createUser+"&beginDate="+beginDate+"&endDate="+endDate;
	}
...
<body>
	<h3 style="margin-bottom: 0px;margin-top: 0px">螺母材质报告退回记录</h3>
	...
	<div id="textureInfo">
		<table>
			<tr>
				...
				<th scope="col" style="width: 75px;">退回人</th>
