				    		...
				    		<c:forEach items="${textureReport.materials}" var="material" varStatus="status">
				    			<tr>
				    				...
				    				<td>
				    					...
				    					<input type="hidden" id="material_name_en${status.index+1 }" name="material_name_en${status.index+1 }" value="${material.material_name_en }" disabled="disabled" >
				    				</td>
				    				<td>
				    				...
				    				<td>
				    					<input type="text" id="num${status.index+1 }" name="num${status.index+1 }" value="${material.num }"  style="width:50px" disabled="disabled">
				    				</td>
				    				<td>
				    					<input type="text" id="size${status.index+1 }" name="size${status.index+1 }" value="${material.size }"  style="width:100px" disabled="disabled"  />
				    				</td>
				    				<td>
				    					<input type="text" id="hex${status.index+1 }" name="hex${status.index+1 }" value="${material.nutProof.hex }"  disabled="disabled">
				    				</td>
				    				<td>
				    					<input type="text" id="hexHex${status.index+1 }" name="hexHex${status.index+1 }" value="${material.nutProof.hexHex }" disabled="disabled">
				    				</td>
				    				<td>
