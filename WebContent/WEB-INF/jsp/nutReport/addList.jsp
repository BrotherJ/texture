...
<script type="text/javascript">
			...
			$.ajax({ 
                ...
                success: function(data) {
                	if(data.succeed){
                		...
                		window.location.href="<%=basePath %>/nutReportSearch/getAddList/?page=1&texture="+texture+"&furnace_No="+furnace_No+"&createUser="+createUser+"&status="+status+"&beginDate="+beginDate+"&endDate="+endDate;
                	}else{
		...
		$.ajax({ 
            ...
            success: function(data) {
            	if(data.succeed){
            		...
            		var beginDate =$('#beginDate').datebox('getValue'); 
            		var endDate =$('#endDate').datebox('getValue'); 
            		window.location.href="<%=basePath %>/nutReportSearch/getAddList/?page=1&texture/?page=1&texture="+texture+"&furnace_No="+furnace_No+"&createUser="+createUser+"&status="+status+"&beginDate="+beginDate+"&endDate="+endDate;
            	}else{
	            	alert(data.msg);
            	}
            } 
	...
	function goPage(pageNum){
		...
		var beginDate =$('#beginDate').datebox('getValue'); 
		var endDate =$('#endDate').datebox('getValue'); 
		window.location.href="<%=basePath %>/nutReportSearch/getAddList/?page="+pageNum+"&texture="+texture+"&furnace_No="+furnace_No+"&createUser="+createUser+"&status="+status+"&beginDate="+beginDate+"&endDate="+endDate;
	}
