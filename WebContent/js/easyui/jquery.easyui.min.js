...
$.fn.validatebox.defaults={required:false,validType:null,validParams:null,delay:200,missingMessage:"此栏位必须填写.",invalidMessage:null,tipPosition:"right",deltaX:0,novalidate:false,events:{focus:_422,blur:_426,mouseenter:_42a,mouseleave:_42d,click:function(e){
var t=$(e.data.target);
if(!t.is(":focus")){
t.trigger("focus");
}
...
},message:"输入值必须介于{0}到{1}位之间."},remote:{validator:function(_450,_451){
var data={};
data[_451[1]]=_450;
